...
#' 
#' Some hints: if you are using a function that doesn't work "cleanly" on matrices (e.g. var), your calc_hpc
#' function should use an apply(x,1,single_pixel_function), e.g. use this as the fun for calc_hpc for var:
#' 
#' fun=function(x)
#' 		{ 
#' 			var_x=apply(x,1,var)
